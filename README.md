...
## Introduction
This is the implementation of the barebones of an online marketplace. A server-side web API that can help you build your own online shop. Shopicho was built using **Ruby on Rails** framework. Demo: https://shopicho.herokuapp.com (Refer to [List of Endpoints](#list-of-endpoints) in order to use it properly. I suggest to use Postman or httpie for better experience)
